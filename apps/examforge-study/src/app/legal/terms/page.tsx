...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
	return createLegalMetadata("terms", resolveLegalLocale((await searchParams).lang))
}

export default async function Page({ searchParams }: Props) {
	return <LegalPage document="terms" locale={resolveLegalLocale((await searchParams).lang)} />
}
