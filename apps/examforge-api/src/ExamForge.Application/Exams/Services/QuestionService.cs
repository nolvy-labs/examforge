...
public sealed class QuestionService
{
    ...
    private readonly IExamSectionRepository _sections;
    private readonly IExamVersionRepository _versions;
    private readonly IUnitOfWork _unitOfWork;

    public QuestionService(
        IQuestionRepository questions,
        IExamSectionRepository sections,
    ...
    private static QuestionDetailResponse ToDetailResponse(QuestionDetailData detail) =>
        new(
            ...
            detail.Options.Select(QuestionOptionService.ToResponse).ToList(),
            detail.AnswerKeys.Select(FillAnswerKeyService.ToResponse).ToList());
