...
{
    private readonly IExamVersionRepository _versions;
    private readonly IExamVersionContentCloner _contentCloner;
    private readonly IExamVersionPublishReadinessChecker _readinessChecker;
    private readonly ICurrentUserContext _currentUser;
    private readonly IUnitOfWork _unitOfWork;

    public ExamVersionService(
        IExamVersionRepository versions,
        IExamVersionContentCloner contentCloner,
        IExamVersionPublishReadinessChecker readinessChecker,
