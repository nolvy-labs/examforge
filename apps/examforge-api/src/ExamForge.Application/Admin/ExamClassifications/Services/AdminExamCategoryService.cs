...
public sealed class AdminExamCategoryService
{
    private readonly IAdminExamCategoryRepository _examCategories;
    private readonly IUnitOfWork _unitOfWork;

    public AdminExamCategoryService(
        IAdminExamCategoryRepository examCategories,
    ...
    public async Task<IReadOnlyCollection<ExamCategoryResponse>> ListAsync(
        bool? isArchived,
        CancellationToken cancellationToken = default)
    {
        var categories = await _examCategories.ListAsync(
            isArchived,
            cancellationToken);
